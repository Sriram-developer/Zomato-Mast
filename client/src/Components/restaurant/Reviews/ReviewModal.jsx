...
export default function ReviewModal({ isOpen, setIsOpen, ...props }) {
  ...
  const toggleDining = () => 
  setReviewData((prev) => ({ ...prev, isRestaurantReview: !reviewData.isRestaurantReview, isFoodReview: false }));
  
  const toggleDelivery = () => 
  setReviewData((prev) => ({...prev, isRestaurantReview: false,  isFoodReview: !reviewData.isFoodReview, }));
